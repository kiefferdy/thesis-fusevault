...
contract CIDStorage {
    ...
    function storeCIDDigest(string memory cid) public {
        ...
        // Store the CID digest and its timestamp in the users's record
    ...
    /**
     * @dev Fetch all CID digest hashes under addr
     * @param user The address to query
     * @return digestHashes Array of CID digest hashes linked to addr
     */
    ...
    /**
     * @dev Fetch all CID digest hashes w/t addr
     * @return digestHashes Array of CID digest hashes linked to the user's addr
     */
